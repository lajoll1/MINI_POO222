...
root_button_1=tk.Button(root,text="importer")
...
tab_1_rad_but_1=Checkbutton(tab_1_right_frame,text='Afficher Vitesses')
tab_1_rad_but_1.grid(row=0,column=0)
tab_1_rad_but_2=Checkbutton(tab_1_right_frame,text='Afficher accélérations')
tab_1_rad_but_2.grid(row=1,column=0)
tab_1_but_1=Button(tab_1_right_frame,text='Lancer affichage')
...
tab_2_rad_but_1=Checkbutton(tab_2_right_frame,text='Angle')
tab_2_rad_but_1.grid(row=1,column=0)
tab_2_rad_but_2=Checkbutton(tab_2_right_frame,text='Position')
tab_2_rad_but_2.grid(row=2,column=0)
tab_2_but_1=Button(tab_2_right_frame,text="Tracer l'évolution")
...
tab_3_left_but_1=Button(tab_3_left_frame,text="Lancer la recherche")
tab_3_left_but_1.grid(row=1,column=0)

tab_3_left_lstbox_1=Listbox(tab_3_left_frame)
...
tab_3_center_but_1=Button(tab_3_center_frame,text="Lancer la recherche")
tab_3_center_but_1.grid(row=1,column=0)

tab_3_center_lstbox_1=Listbox(tab_3_center_frame)
tab_3_center_lstbox_1.grid(row=2,column=0)
tab_3_center_lstbox_1.insert(1,"élément 1") #(index, valeur)


#right_frame
tab_3_right_but_1=Button(tab_3_right_frame,text="Lister et Enregistrer les règles activées")
